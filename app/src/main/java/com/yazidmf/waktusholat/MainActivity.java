...
import com.yazidmf.waktusholat.api.ApiService;
import com.yazidmf.waktusholat.api.ApiUrl;
    ...
    private void getJadwal () {
        ...
        call.enqueue(new Callback<ModelJadwal>() {
            ...
            public void onFailure(Call<ModelJadwal> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MainActivity.this, "Servernya gagal dihubungi nih, Gan...", Toast.LENGTH_SHORT).show();
            }
        });
